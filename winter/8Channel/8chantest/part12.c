...
void *part12(int sr, double *tone, double *left, double *right, double *pan)
{
	...
	double Carrier[] = {329.63, 880, 783.99, 440, 392, 523.25, 329.63, 164.81} ;  // carrier freqs
	...
	double startTime[] = {190.0, 192.0, 199.0, 207.0, 212.0, 220.0, 222.0, 230.0};            // start time for each tone
