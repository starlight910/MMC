...
int main(int argc, char* argv[])
{
	...
	double partialF[] = {1.0, 1.25, 1.5, 1.75, 2.0, 2.25}; // partial frequency
	double partialA[] = {1.0, 0.9, 0.8, 0.7, 0.6, 0.5};    // partial amplitude
	double Xval[5] = {0, 0.2, 0.3, 0.5, 1};
	double Yval[5] = {0, 1, 0.7, 0.4, 0};
	...
	void adsr2(short sound[], double dur, int sr, double tone[], double A[], int nPartials, int F);
