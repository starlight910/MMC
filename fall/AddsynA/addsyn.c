...
int main(void)
{
	...
	short *sound2;
	short *sound3;
	short ComSound;    // combined sounds
	...
	double envelopT[] = {0.0, 0.1, 0.3, 0.8, 1.0};          // envelop time
	double envelopA[] = {0.0, 1.0, 0.5, 0.4, 0.4};          // envelop amplitude
	int nEnvelop = 5;  // total number of envelops

	int nSequence = 4;  // number of pieces to be put together

	int samples;         // number of samples of the sound
	int Newsamples;      // new sample size for cat
	int dataSizeInBytes; // total number of partials
	int NewdataSizeInBytes // 
