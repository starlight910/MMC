...
int main(void)
{
	...
	double partialF[] = {1, 0.99, 0.89, 0.79, 0.69, 0.59}; // partial frequency
	double partialA[] = {1.0, 1/0.2, 1/0.4, 1/0.8, 1/0.16, 1/0.32};    // partial amplitude
	...
	sfsave("wave.wav", sound, dur, sr, nchan);
